...
scrollSpeed = 0.00 #adjust the scrolling speed here-> smaller number=faster scroll
TextColor = (5,55,50) #set the color of your text here in RGB, default is white
